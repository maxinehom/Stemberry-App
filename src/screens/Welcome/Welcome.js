...
import { View, ActivityIndicator, Text, TouchableOpacity, ScrollView, Image, Alert, Button } from 'react-native';
...
const Welcome = () => {
    ...
    return (<ScrollView style={Layout.fill} contentContainerStyle={[
            Layout.fullSize,
            Layout.fill,
            Layout.colCenter,
      ...
      <View style={[
        ...
        <Image style={[
        ]} source={Images.backgrounds.bgWelcome} resizeMode={'cover'}/>
      ...
      <View style={[
        ...
        <View>
          <Text style={[Fonts.titleSmall, Fonts.textCenter]}>{t('welcome:title')}</Text>
        ...
        <TouchableOpacity style={[Common.button.rounded, Gutters.smallBMargin]} >
